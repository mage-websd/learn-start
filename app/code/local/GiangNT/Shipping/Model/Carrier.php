...
class GiangNT_Shipping_Model_Carrier extends Mage_Shipping_Model_Carrier_Abstract
    implements Mage_Shipping_Model_Carrier_Interface
{
     ...
     * @var string
     */
    protected $_code = 'giangnt_shipping';
    /**
    ...
    public function collectRates(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        /** @var GiangNT_Shipping_Helper_Data $expressMaxProducts */
        $expressMaxWeight = Mage::helper('giangnt_shipping')->getExpressMaxWeight();
