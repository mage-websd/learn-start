...
<li>If you are unable to visit our multiple DFW locations you can send us your valuables in an easy-to-use, insured mailer by visiting our sister company <a href="http://www.americangoldandsilverexchange.com/" title="American Gold & Silver Exchange" target="_blank">American Gold & Silver Exchange</a>.</li>
</ul>
</div>
</div>
<!-- // end left sell -->
...
<div class="text_4">If you are unable to visit our multiple DFW locations you can send us your valuables in an ease-to-use, insured mailer by visiting our sister company <a href="http://www.americangoldandsilverexchange.com/" title="American Gold & Silver Exchange" target="_blank">American Gold & Silver Exchange</a>.</div>
</div>
</div>
<div class="right-sell span6"><!-- // right sell --> {{block type="core/template" template="sell/form.phtml"}}</div>
<!-- // end right sell --></div>
