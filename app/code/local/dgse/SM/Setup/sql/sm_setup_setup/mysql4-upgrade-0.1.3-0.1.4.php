...
$pageId = $collection = Mage::getModel('cms/page')->getCollection()->addFieldToFilter('identifier', 'privacy-policy')->getFirstItem()->getId();
...
<div class="block-content clearfix">{{block type="core/template" block_id="location" template="location/list.phtml"}}</div>
</div>
</div>
<div class="span5" data-tablet="span6">
