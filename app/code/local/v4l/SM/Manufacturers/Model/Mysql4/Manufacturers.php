...
class SM_Manufacturers_Model_Mysql4_Manufacturers extends Mage_Core_Model_Mysql4_Abstract
{
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        ...
        if(isset($_POST['productIds'])) {
            ...
            // get positions
            $positionJson = $_POST['positions'];
            $positionArray = json_decode($positionJson, true);
            ...
            foreach ($Result as $_productId) {
                ...
                $productsArray = array();
                $productsArray['position'] = $positionArray[$_productId];
