<?php
class SM_Xblock_Block_Manage_Xblock_Edit_Tab_Categories extends Mage_Adminhtml_Block_Catalog_Category_Tree
{
    ...
    {
        parent::__construct();
        $this->setTemplate('sm_xblock/catalog/product/edit/categories.phtml');
    }
     ...
     */
    public function getXblock()
    {
        return Mage::registry('xblock_data');
    }
    ...
    {
        return false; //$this->getXblock()->getCategoriesReadonly();
    }

    protected function getCategoryIds()
    {
		if($this->getXblock()){
			$IDList = $this->getXblock()->getCategoryId();
			if (is_array($IDList) and sizeof($IDList) > 0) {
				return $IDList;
			}
		}
        return array();
