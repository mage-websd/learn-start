...
class SM_Xpermission_Block_System_Config_Switcher extends Mage_Adminhtml_Block_System_Config_Switcher
{
    /**
    ...
    public function getStoreSelectOptions()
    {
        ...
        if (Mage::getSingleton('admin/session')->getUser()->isRoot()) {
            ...
            foreach ($storeModel->getWebsiteCollection() as $website) {
                ...
                foreach ($storeModel->getGroupCollection() as $group) {
                    if ($group->getWebsiteId() != $website->getId()
                            || $group->getWebsiteId() != Mage::getSingleton('admin/session')->getUser()->getWebsiteId()) {
                        continue;
                    }
                    $groupShow = false;
                    foreach ($storeModel->getStoreCollection() as $store) {
