 ...
 */
class SM_Xpermission_Block_System_Store_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
        ...
        if ($showGroupFieldset) {
            ...
            if (Mage::registry('store_action') == 'edit'
                ...
                if (Mage::getSingleton('admin/session')->getUser()->isRoot()) {
                    ...
                    $fieldset->addField('group_website_id', 'hidden', array(
                            'name' => 'group[website_id]',
                            'value' => Mage::getSingleton('admin/session')->getUser()->getWebsiteId(),
                            'id'   => '_group_websites',
                    ));
                }
        ...
        if ($showStoreFieldset) {
            ...
            if (Mage::registry('store_action') == 'edit'
                ...
                foreach ($websites as $website) {
                    ...
                    } elseif ($website->getId() == Mage::getSingleton('admin/session')->getUser()->getWebsiteId()) {
                        $values = array();
                        foreach ($allgroups as $group) {
                            if ($group->getWebsiteId() == $website->getId()) {
                                $values[] = array('label'=>$group->getName(),'value'=>$group->getId());
