 ...
 */
class SM_Xpermission_Block_System_Config_Tabs extends Mage_Adminhtml_Block_Widget
{
    ...
    public function initTabs()
    {
        ...
        $websiteCode = $this->__getWebsiteCode();
    ...
    public function getStoreSelectOptions()
    {
        ...
        $curWebsite = $this->__getWebsiteCode();
		...
		if (is_array($_websiteList) and in_array('1', $_websiteList)) {
        ...
        foreach ($storeModel->getWebsiteCollection() as $website) {
            ...
            foreach ($storeModel->getGroupCollection() as $group) {
				...
				if (is_array($_websiteList) and in_array($group->getWebsiteId(), $_websiteList)) {
					$groupShow = false;
     ...
     * @return string
     */
    private function __getWebsiteCode()
    {
		$_websiteList = Mage::getSingleton('admin/session')->getUser()->getWebsiteId();
		if (is_array($_websiteList) and sizeof($_websiteList) == 1) {
			return Mage::getModel('core/website')->load($_websiteList[0])->getCode();
		}
