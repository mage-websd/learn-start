 ...
 */
class SM_Xpermission_Block_System_Config_Form extends Mage_Adminhtml_Block_Widget_Form
{
    ...
    public function getWebsiteCode()
    {
		...
		if (empty($_website)) {
			...
			foreach ($_websiteList as $_ID) {
				return Mage::getModel('core/website')->load($_ID)->getCode();
			}
		}
		return $_website;
    }
