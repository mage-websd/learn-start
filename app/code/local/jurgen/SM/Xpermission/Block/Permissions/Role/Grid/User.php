 ...
 */
class SM_Xpermission_Block_Permissions_Role_Grid_User extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        ...
        if (!Mage::getSingleton('admin/session')->getUser()->isRoot()) {
            $_websiteList = array(Mage::getSingleton('admin/session')->getUser()->getWebsiteId());
