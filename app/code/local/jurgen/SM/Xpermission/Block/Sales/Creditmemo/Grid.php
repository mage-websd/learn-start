 ...
 */
class SM_Xpermission_Block_Sales_Creditmemo_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    protected function _prepareCollection()
    {
        ...
        if (!Mage::getSingleton('admin/session')->getUser()->isRoot()) {
            ...
            $_storeList = Mage::getModel('core/website')->load($_websiteID)->getStoreIds();
            if (sizeof($_storeList) == 0) {
                $_storeList = array(0);
            }
            $collection->addFieldToFilter('store_id',$_storeList);
        }
