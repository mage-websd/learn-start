 ...
 */
class SM_Xpermission_Block_Customer_Edit_Tab_Account extends Mage_Adminhtml_Block_Widget_Form
{
...
//        }
		...
		if (Mage::app()->isSingleStoreMode()
			|| (is_array($_websiteList) and sizeof($_websiteList) == 1)) {
			$fieldset->removeField('website_id');
			$fieldset->addField('website_id', 'hidden', array(
				'name'      => 'website_id'
			));
			$customer->setWebsiteId($_websiteList[0]);
		}
