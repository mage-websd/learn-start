<?php
require_once 'Mage'.DS.'Adminhtml'.DS.'controllers'.DS.'Promo'.DS.'QuoteController.php';
class SM_Xpermission_Promo_QuoteController extends Mage_Adminhtml_Promo_QuoteController {
