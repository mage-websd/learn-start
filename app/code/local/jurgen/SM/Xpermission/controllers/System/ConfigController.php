 ...
 */
require_once('Mage' .DS. 'Adminhtml' .DS. 'controllers' .DS. 'System' .DS. 'ConfigController.php');

class SM_Xpermission_System_ConfigController extends Mage_Adminhtml_System_ConfigController {
