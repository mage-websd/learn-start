 ...
 */
class SM_Xticket_Block_Adminhtml_Xticket_Edit_Tab_General extends Mage_Adminhtml_Block_Widget_Form
{
...
//		$this->_blockGroup = 'xticket';
	...
	protected function _prepareForm()
	{
		...
		$this->setChild('form',
			$this->getLayout()->createBlock('xticket/adminhtml_xticket_edit_tab_general_form')
		);	  
