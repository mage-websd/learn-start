...
class SM_Xticket_Block_Adminhtml_Template_Grid extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _prepareCollection() {
        $collection = Mage::getModel('xticket/templates')->getCollection();
        $store = $this->_getStore();
        if ($store->getId()) {
            $collection->addStoreFilter($store);
        }
      //  print "<pre>";
       // print_r(get_class_methods(Mage::getSingleton('admin/session')->getUser()));die;
        /*   if (!Mage::getSingleton('admin/session')->getUser()->userExists()) {
    ...
    protected function _prepareColumns() {
        ...
        $this->addColumn('name', array(
                'header'    => Mage::helper('xticket')->__('Title'),
                'align'     =>'left',
                'index'     => 'name',
        ));
